<section class="news fix" style=" background:url(/media/img/bg.jpg) no-repeat;background-size:cover;">
    <div class="news-list" style="text-align: center; padding-left:35%; padding-right:15%; width: 30%;">
