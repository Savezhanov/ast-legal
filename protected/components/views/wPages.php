...
if ($this->pages > 1):
    ...
    <div class="page-navi">
        ...
        if(strpos($actual_link,'&page') == true){
            $end = strpos($actual_link,'&page');
            $url = substr($actual_link,0,$end);
        }else {
            $url = $actual_link;
        }
        ...
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            ...
            if($this->page<=5 && $this->pages>5){
                ...
                if($i<6){
                    ...
                    if($i==5){
                        ...
                        $get['page'] = $this->pages;
                        echo '<a class="page" href="'.$url.'&page='.$get['page'].'">'.$this->pages.'</a>';
                    }
                }
            }
            ...
            if($this->page>5 &&  $this->pages-2 < $i){
                ...
                $getspages = $i;
                if($max==0){
                    echo '<a class="page" href="'.$url.'&page='.$get['page'].'">1</a>';
                    echo '<span class="page">...</span>';
                    $max++;
                }
