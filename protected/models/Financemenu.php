<?
class Financemenu extends CActiveRecord
{
    ...
    {
        return array(
            array('created_at, category_id,', 'numerical', 'integerOnly'=>true),
            array('name_text, url_text, serial_number, short_description , title', 'length', 'max'=>255),
    ...
    {
        return array(
            'parentcategory'=>array( self::BELONGS_TO, 'Financecategory', 'category_id' )
        );
    }
