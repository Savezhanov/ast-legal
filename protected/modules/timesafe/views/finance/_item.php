<div class="row">
    <div class="offset">
        ...
        <p class="pull-right">
            <?=CHtml::checkbox('FinanceCheck[status_int][' . $data->id . ']', $data->status_int, array('class' => 'toggle-on-check'))?>
        ...
        <div style="display: inline-block">
            ...
            <h3 style = "margin-top:5px;">
                <a target = "_blank" href = "/finance"><?=$data->name_text?></a>
            </h3>
            <?php $parentname = Financemenu::model()->find(" id = '$data->menu_id'")->name_text; ?>
            <p style = "margin-left:0; font-weight:bold;">Порядковый номер: <?=$data->serial_number?></p>
            <p style = "margin-left:0; font-weight:bold;">Меню статей: <a target="_blank"><?=$parentname?></a></p>
        </div>
    </div>
</div>