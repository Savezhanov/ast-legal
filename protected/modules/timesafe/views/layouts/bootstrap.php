        ...
        array(
            ...
            'items'=>array(
                ...
                array('label'=>'Услуги','url'=>'#','icon'=>'icon-th','items'=>array(
                    array('label'=>'Категории услуг', 'url'=>array('financecategory/list'),'icon'=>'icon-pencil'),
                    array('label'=>'Меню услуг', 'url'=>array('financemenu/list'),'icon'=>'icon-pencil'),
                    array('label'=>'Услуги', 'url'=>array('finance/list'),'icon'=>'icon-pencil'),
                )),
