...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
        ...
        <?php echo $form->dropDownListRow($model, 'age', array('возраст' => $number), array('class'=>'span-number')); ?>
        <?php echo $form->dropDownListRow($model, 'serial_number', array('порядковый номер' => $number), array('class'=>'span-number')); ?>
        <?php echo $form->textAreaRow($model, 'short_description', array('size' => 60, 'maxlength' => 700, 'class'=>'span12')); ?>
